/**
 * Routes Batch Delete Functionality
    ...
    try {
        ...
        if (response.ok && data.success) {
            ...
            if (typeof Toast !== 'undefined') {
                Toast.success(data.message || 'Routes deleted successfully');
            }
            ...
            throw new Error(data.message || 'Failed to delete routes');
        }
    } catch (error) {
        ...
        if (typeof Toast !== 'undefined') {
            Toast.error(error.message || 'An error occurred while deleting routes');
        } else {
            alert('Error: ' + (error.message || 'Failed to delete routes'));
        }
    }
}
